...
public class UpdateUserImageDatabaseActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks,
        ...
        storageReference.putFile(uri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(UpdateUserImageDatabaseActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
